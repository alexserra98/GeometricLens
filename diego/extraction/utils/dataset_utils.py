    ...
    def construct_prompt(
        ...
        for i, question in enumerate(questions):
            ...
            if self.declarative:
                ...
                prompt += f"The following is a multiple choice question (with answers) about{self.format_subject(subjects[i])}. After Answer: you must reply with one of the following letters: A B C D .\n\n"
                prompt += question
