...
def get_repr_for_dynmics(
    ...
    name = f"cluster_{model}_{mode}_epoch4_eval_{dataset}_0shot.pkl"
    with open(f"{results_dir}/{folder}/{model}/{name}", "rb") as f:
        clus_train = pickle.load(f)

    name = f"overlap_{model}_{mode}_epoch4_eval_{dataset}_0shot.pkl"
    with open(f"{results_dir}/{folder}/{model}/{name}", "rb") as f:
        ov_train = pickle.load(f)

    name = f"overlap_repr_{model}_{mode}_epoch4_eval_dev+validation_Noneshot.pkl"
    with open(f"{results_dir}/{folder}/{model}/{name}", "rb") as f:
        comparison_ov = pickle.load(f)

    name = f"cluster_repr_{model}_{mode}_epoch4_eval_dev+validation_Noneshot.pkl"
    with open(f"{results_dir}/{folder}/{model}/{name}", "rb") as f:
...
ax.plot(
    ov_train_ll3["letters-ep-0-0.1"], marker=".", label="epoch 0", color="C3", alpha=0.2
)
ax.plot(
    ov_train_ll3["letters-ep-1-0.1"],
    marker=".",
    label="epoch 1",
    color="C3",
    alpha=0.35,
...
ax.plot(
    ov_train_ll3["letters-ep-4-0.1"], marker=".", label="epoch 4", color="C3", alpha=1
)

nlayers = len(ov_train_ll3["letters-ep-4-0.1"])
...
ax.plot(
    comparison_ov_ll3["ep0_k30"], marker=".", label="epoch 0", color="C0", alpha=0.2
)
ax.plot(
    comparison_ov_ll3["ep1_k30"], marker=".", label="epoch 1", color="C0", alpha=0.35
)
ax.plot(
    comparison_ov_ll3["ep2_k30"], marker=".", label="epoch 2", color="C0", alpha=0.55
)
ax.plot(comparison_ov_ll3["ep4_k30"], marker=".", label="epoch 4", color="C0", alpha=1)
...
ax.plot(
    ov_train_ll2["letters-ep-0-0.1"], marker=".", label="epoch 0", color="C3", alpha=0.2
)
ax.plot(
    ov_train_ll2["letters-ep-1-0.1"],
    marker=".",
    label="epoch 1",
    color="C3",
    alpha=0.35,
...
ax.plot(
    ov_train_ll2["letters-ep-4-0.1"], marker=".", label="epoch 4", color="C3", alpha=1
)
nlayers = len(ov_train_ll2["letters-ep-4-0.1"])
...
ax.plot(
    comparison_ov_ll2["ep0_k30"], marker=".", label="epoch 0", color="C0", alpha=0.2
)
ax.plot(
    comparison_ov_ll2["ep1_k30"], marker=".", label="epoch 1", color="C0", alpha=0.35
)
ax.plot(
    comparison_ov_ll2["ep2_k30"], marker=".", label="epoch 2", color="C0", alpha=0.55
)
ax.plot(comparison_ov_ll2["ep4_k30"], marker=".", label="epoch 4", color="C0", alpha=1)
