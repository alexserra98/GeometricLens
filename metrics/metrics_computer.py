...
parser.add_argument('--metric-type', choices=["per_instance", "across_instaces"], type=str, help='Metrics on the single instance or Metrics computed across different instances')
